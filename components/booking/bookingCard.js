...
const BookingCard = ({ booking, inbounded, setSideBar,setLoading }) => {
    ...
    useEffect(() => {
        ...
        setImg(null);
        setColor(0);
        booking && getItemDetail(booking.item_id);
        booking && getOwnerdetail(booking.owner_email);
        booking && getCustomerdetail(booking.customer_email);
    }, [booking?.item_id]);
    useEffect(() => {
